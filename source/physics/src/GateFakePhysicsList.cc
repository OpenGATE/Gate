...
#ifndef GATEFAKEPHYSICSLIST_CC
#define GATEFAKEPHYSICSLIST_CC

/*
 * \file  GateFakePhysicsList.cc
...
void GateFakePhysicsList::ConstructBosons()
{
  // pseudo-particles
...
void GateFakePhysicsList::ConstructLeptons()
{
  // leptons
...
void GateFakePhysicsList::ConstructProcess()
{
  AddTransportation();
  ConstructEM();
  ConstructGeneral();
...
void GateFakePhysicsList::SetCuts()
{
  if (verboseLevel >0){
...
#endif /* end #define GATEFAKEPHYSICSLIST_CC */
