...
G4HybridRayleighProcess::G4HybridRayleighProcess()
{
  mInVolumeSplit = 150;
  mOutVolumeSplit = 150;
  mCurrentSplit = 150;
...
G4VEmProcess* G4HybridRayleighProcess::GetEmProcess()
{
  return dynamic_cast<G4VEmProcess*>(pRegProcess);
}

G4VParticleChange *G4HybridRayleighProcess::PostStepDoIt(const G4Track& track, const G4Step& step)
{
