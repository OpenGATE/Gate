/*----------------------
  ...
  Modified version 11-10-2013 for mixed Physics using dna
...
//-----------------------------------------------------------------------------------------
//Enable mixed EM physics List with DNA
  void GatePhysicsList::ConstructPhysicsListDNAMixed(G4String name) {
      if (name == "emstandard_opt3_mixed_emdna") emPhysicsListMixed = new GateMixedDNAPhysics("emstandard_opt3_mixed_emdna");
      else if (name== "emlivermore_mixed_emdna") emPhysicsListMixed = new GateMixedDNAPhysics("emlivermore_mixed_dna");
      else GateError("The mixed Physics List "<<name<<" does not exist!");
  }
