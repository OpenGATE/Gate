...
void GateImageDeformActor::readPDFFile ( G4String filename )
{
  ...
  GateMessage ( "Actor", 4, "GateImageDeformActor -- Read file - begin " << filename << G4endl );
  ...
  GateMessage ( "Actor", 4, "GateImageDeformActor -- Read file - end " << filename << G4endl );
}
...
void GateImageDeformActor::EndOfRunAction ( const G4Run * r )
{
  ...
  GateMessageDec ( "Actor",4,"GateImageDeformActor() -- end"<<G4endl );
}
//-----------------------------------------------------------------------------
