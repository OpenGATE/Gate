...
std::ostream& operator<<(std::ostream& flux, const GatePulse& pulse)
{
  flux    << "\t----GatePulse----"     	      	      	      	      	      	      	      	      	      	               << Gateendl
	  ...
	  << "\t\t" << "Src           " << pulse.m_sourceID << " [ " << G4BestUnit(pulse.m_sourcePosition,"Length")     << "]" << Gateendl
      	  << "\t\t" << "Time          " << G4BestUnit(pulse.m_time,"Time")      	      	      	      	      	       << Gateendl
      	  << "\t\t" << "Energy        " << G4BestUnit(pulse.m_energy,"Energy")          	      	      	      	       << Gateendl
      	  << "\t\t" << "localPos      [ " << G4BestUnit(pulse.m_localPos,"Length")        	      	      	      	<< "]" << Gateendl
      	  << "\t\t" << "globalPos     [ " << G4BestUnit(pulse.m_globalPos,"Length")   	      	      	      	      	<< "]" << Gateendl
       	  << "\t\t" << "           -> ( R="   << G4BestUnit(pulse.m_globalPos.perp(),"Length")     << ", "
	      	      	      	  << "phi="   << pulse.m_globalPos.phi()/degree       	      	   << " deg,"
				  << "z="     << G4BestUnit(pulse.m_globalPos.z(),"Length")     	     	      	<< ")" << Gateendl
	  ...
	  << "\t\t" << "#Rayleigh     " << pulse.m_nPhantomRayleigh      	      	      	      	      	      	       << Gateendl
      	  << "\t\t" << "scannerPos    [ " << G4BestUnit(pulse.m_scannerPos,"Length")        	      	      	      	<< "]" << Gateendl
      	  << "\t\t" << "scannerRotAngle " << pulse.m_scannerRotAngle/degree           	      	      	      	     << " deg" << Gateendl
     	  << "\t-----------------" << Gateendl;
