...
GateToDigi::~GateToDigi()
{
  ...
  if (nVerboseLevel > 0) G4cout << "GateToDigi deleting..." << Gateendl;
}
//---------------------------------------------------------------------------
...
{
  if (nVerboseLevel > 2)
    G4cout << "GateToDigi::RecordBeginOfAcquisition" << Gateendl;
...
{
  if (nVerboseLevel > 2)
    G4cout << "GateToDigi::RecordEndOfAcquisition" << Gateendl;
}
//---------------------------------------------------------------------------
...
{
  if (nVerboseLevel > 2)
    G4cout << "GateToDigi::RecordBeginOfRun" << Gateendl;
}
//---------------------------------------------------------------------------
...
{
  if (nVerboseLevel > 2)
    G4cout << "GateToDigi::RecordEndOfRun" << Gateendl;
}
//---------------------------------------------------------------------------
...
{
  if (nVerboseLevel > 2)
    G4cout << "GateToDigi::RecordBeginOfEvent" << Gateendl;
}
//---------------------------------------------------------------------------
...
{
  if (nVerboseLevel > 2)
    G4cout << "GateToDigi::RecordEndOfEvent" << Gateendl;
...
{
  if (nVerboseLevel > 2)
    G4cout << "GateToDigi::RecordStep" << Gateendl;
}
//---------------------------------------------------------------------------
