...
{  
  ...
  if (mh == NULL) {
     G4Exception(" !!! [GateSinoToEcat7::RecordBeginOfAcquisition]:\n"
...
void GateSinoToEcat7::RecordBeginOfRun(const G4Run * )
{
  ...
  if ((m_span<1)||((float)((m_span-1)/2)) != (((float)m_span-1.0)/2.0)) {
    ...
    G4Exception(" !!! [GateSinoToEcat7::FillData]:\n"
      	      	"Could not fill subheader");
  }		
...
void GateSinoToEcat7::FillMainHeader()
{
  ...
  if (setMaker->GetRingNb() != RingNb) {
     G4Exception(" !!! [GateSinoToEcat7::FillMainHeader]:\n"
