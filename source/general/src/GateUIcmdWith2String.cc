...
//---------------------------------------------------------------------------
GateUIcmdWith2String::GateUIcmdWith2String
...
//---------------------------------------------------------------------------
void GateUIcmdWith2String::SetParameterName
(const char * theName1, const char * theName2, G4bool omittable1, G4bool omittable2, G4bool currentAsDefault)
{
...
//---------------------------------------------------------------------------
void GateUIcmdWith2String::SetCandidates(const char * candidateList1, const char * candidateList2)
{
  G4UIparameter * theParam = GetParameter(0);
...
//---------------------------------------------------------------------------
void GateUIcmdWith2String::SetDefaultValue(const char * defVal1, const char * defVal2)
{
  G4UIparameter * theParam = GetParameter(0);
