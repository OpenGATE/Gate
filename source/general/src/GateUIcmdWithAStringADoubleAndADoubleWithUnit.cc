...
#ifndef GATEUICMDWITHASTRINGADOUBLEANDADOUBLEWITHUNIT_CC
#define GATEUICMDWITHASTRINGADOUBLEANDADOUBLEWITHUNIT_CC

#include "GateUIcmdWithAStringADoubleAndADoubleWithUnit.hh"

//---------------------------------------------------------------------------
GateUIcmdWithAStringADoubleAndADoubleWithUnit::GateUIcmdWithAStringADoubleAndADoubleWithUnit(const char * theCommandPath,G4UImessenger * theMessenger)
:G4UIcommand(theCommandPath,theMessenger)
{
  ...
  G4UIparameter * strParam3 = new G4UIparameter('d');
...
//---------------------------------------------------------------------------
void GateUIcmdWithAStringADoubleAndADoubleWithUnit::SetParameterName
...
//---------------------------------------------------------------------------
void GateUIcmdWithAStringADoubleAndADoubleWithUnit::SetCandidates(const char * candidateList1, const char * candidateList2,
...
//---------------------------------------------------------------------------
void GateUIcmdWithAStringADoubleAndADoubleWithUnit::SetDefaultValue(const char * defVal1, const char * defVal2,
