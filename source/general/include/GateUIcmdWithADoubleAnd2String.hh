...
/*
  \class  GateUIcmdWithADoubleAnd2String
  \author thibault.frisson@creatis.insa-lyon.fr
          laurent.guigues@creatis.insa-lyon.fr
	  david.sarrut@creatis.insa-lyon.fr
*/

#ifndef GATEUICMDWITHADOUBLEAND2STRING_HH
#define GATEUICMDWITHADOUBLEAND2STRING_HH

#include "G4UIcommand.hh"

class GateUIcmdWithADoubleAnd2String : public G4UIcommand
{
  public: // with description
    GateUIcmdWithADoubleAnd2String(const char * theCommandPath,G4UImessenger * theMessenger);
    //  Constructor. The command string with full path directory
    // and the pointer to the messenger must be given.
    void SetParameterName(const char * theName1, const char * theName2,const char * theName3,
                          G4bool omittable1, G4bool omittable2, G4bool omittable3,
  ...
  void SetDefaultValue(const char * defVal1, const char * defVal2, const char * defVal3);
