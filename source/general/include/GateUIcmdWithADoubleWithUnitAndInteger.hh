...
#ifndef GATEUICMDWITHADOUBLEWITHUNITANDINTEGER_HH
#define GATEUICMDWITHADOUBLEWITHUNITANDINTEGER_HH

#include "G4UIcommand.hh"

class GateUIcmdWithADoubleWithUnitAndInteger : public G4UIcommand
{
  public: // with description
    GateUIcmdWithADoubleWithUnitAndInteger(const char * theCommandPath,G4UImessenger * theMessenger);
