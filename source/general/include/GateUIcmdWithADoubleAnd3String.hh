...
/*
  \class  GateUIcmdWithADoubleAnd3String
...
#ifndef GATEUICMDWITHADOUBLEAND3STRING_HH
#define GATEUICMDWITHADOUBLEAND3STRING_HH

#include "G4UIcommand.hh"

class GateUIcmdWithADoubleAnd3String : public G4UIcommand
{
  public: // with description
    GateUIcmdWithADoubleAnd3String(const char * theCommandPath,G4UImessenger * theMessenger);
    //  Constructor. The command string with full path directory
    // and the pointer to the messenger must be given.
  virtual ~GateUIcmdWithADoubleAnd3String(){;}
