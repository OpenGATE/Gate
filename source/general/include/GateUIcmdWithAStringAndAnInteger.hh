...
/*
  \class  GateUIcmdWithAStringAndAnInteger
...
#ifndef GATEUICMDWITHAINTANDASTRING_HH
#define GATEUICMDWITHAINTANDASTRING_HH

#include "G4UIcommand.hh"

class GateUIcmdWithAStringAndAnInteger : public G4UIcommand
{
  public: // with description
    GateUIcmdWithAStringAndAnInteger(const char * theCommandPath,G4UImessenger * theMessenger);
    //  Constructor. The command string with full path directory
    // and the pointer to the messenger must be given.
  virtual ~GateUIcmdWithAStringAndAnInteger(){;}
    void SetParameterName(const char * theName1, const char * theName2,
                          G4bool omittable1, G4bool omittable2,
