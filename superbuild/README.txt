...
- from that folder, run 'ccmake .': choose option, type 'c' to
  configure, type 'g' to generate makefile

- compile by using 'make -j 6' (or replace 6 with the number of cores
  of your computer)

- setup the Geant4 environement variables (in order that is can find
